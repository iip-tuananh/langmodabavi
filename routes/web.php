...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('cong-trinh/{slug}.html','PageController@serviceDetail')->name('serviceDetail');
    Route::get('tat-ca-cong-trinh.html','PageController@listService')->name('listService');
    ...
    Route::get('chi-tiet/{slug}.html','ProductController@detail_product')->name('detailProduct');
    ...
    Route::post('category/filter','ProductController@filterProductCate')->name('filterProductCate');
